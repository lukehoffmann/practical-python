...
for stock in portfolio:
    ...
    print(stock['name'], ds.format(stock['old_value']), '→', ds.format(stock['new_value']), format_profit(stock['change']))
...
print("total", ds.format(portfolio_total), '→', ds.format(new_total), format_profit(profit))
